...
\begin{align*}
	...
	z(t)   &=  -\frac{1}{2}x(t)
\end{align*}
Since this system is already stable, our goal is to improve the preference of the system. Before we consider the data that we will use in this example, we will first look at the current preformence of the system. We can calculate the preformence by means of the matlab function \mon{ninf = hinfnorm(sys)}.
\begin{lstlisting}
A = 0.5;
B = 1;
C = -0.5;
